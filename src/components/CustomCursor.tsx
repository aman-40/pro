...
const CustomCursor = () => {
  ...
  return (
    <>
      ...
      <div
        ref={cursorRef}
        className="fixed top-0 left-0 w-4 h-4 -mt-2 -ml-2 rounded-full bg-white mix-blend-difference pointer-events-none z-[9999] shadow-[0_0_10px_rgba(255,255,255,0.8)]"
      />
    </>
  );
};
